  ...
  return (
    <div className="App h-screen flex flex-col">
      ...
      <div class="flex flex-row h-full">
        ...
        <div class="flex flex-col basis-3/4 bg-lightBlue">
          02
          <div class="grow grid grid-rows-2 grid-flow-col auto-cols-max place-content-around content-center gap-8 bg-red justify-center gap-x-8">
