      ...
      <div class="flex flex-row h-full bg-gradient-to-br from-cyan-600 to-violet-400">
        <div class="flex flex-col align-center justify-center basis-1/4 drop-shadow-2xl pl-7">
          ...
          <div class="flex flex-col align-center justify-center basis-1/4 drop-shadow-2xl mx-6 my-4 bg-slate-900/30 rounded-lg">
            ...
            <select name="Major" class="mt-1 mb-3 w-48 self-center text-center bg-white text-black text-sm text-center rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
            ...
            <select name="Minor" class="mt-1 mb-3 w-48 self-center bg-white text-center  text-slate-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
              <option disabled hidden selected class="text-slate-700 text-sm "></option>
              <option value="CS">Computer Science</option>
            </select>
            <div class="text-sm self-center text-left w-48 text-white">Semesters Remaining</div>
            <select name="Semesters" class="w-48 mt-1 mb-3 self-center bg-white text-center text-slate-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
              <option disabled hidden selected class="text-slate-700 text-sm"></option>
            ...
            <input type="text" id="default-input" class="mt-1 mb-3 w-48 self-center text-center bg-gray-50 border border-slate-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 placeholder-slate-700"/>
            ...
            <button type="submit" class="mt-7 mb-7 self-center text-white bg-medBlue hover:bg-medDarkBlue font-medium rounded-lg text-sm w-32 sm:w-auto px-5 py-2.5 text-center">Create a Course Plan</button>
          </div>
        </div>
